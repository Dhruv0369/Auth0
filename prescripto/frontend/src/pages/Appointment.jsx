...
const Appointment = () => {
  ...
  const getAvilableSlots = async () => {
    let slots = []; // Temporary array to hold all time slots
    ...
    for (let i = 0; i < 7; i++) {
      ...
      slots.push(timeSlots); // Add slots to the temporary array
    }

    setDocSlots(slots); // Set state after the loop finishes
  };
